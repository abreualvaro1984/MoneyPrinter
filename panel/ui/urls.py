...
urlpatterns = [
    ...
    path(
        "roteiros/sugerir-temas/",
        views.scripts_suggest_topics,
        name="scripts_suggest_topics",
    ),
    ...
    path("roteiros/<int:pk>/humanizar/", views.scripts_humanize, name="scripts_humanize"),
    path("roteiros/<int:pk>/variante/", views.scripts_variant, name="scripts_variant"),
