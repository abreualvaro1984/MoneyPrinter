...
class TestLlmController(unittest.TestCase):
    def test_generate_video_script_forwards_all_prompt_fields(self):
        """A interface de copywriting não pode perder palavras de prompt avançadas ou números de parágrafo."""
    ...
    def test_generate_video_terms_forwards_order_matching_mode(self):
        """As opções de correspondência de sequência de materiais devem continuar a ser passadas para o serviço de geração de palavras-chave."""
    ...
    def test_generate_social_metadata_returns_service_payload(self):
        """A interface de metadados da plataforma social deve manter a estrutura de resposta dos resultados da camada de serviço."""
